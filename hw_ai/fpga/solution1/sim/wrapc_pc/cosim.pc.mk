...
$(ObjDir)/test_myip_v1_0_HLS.cpp_pre.cpp.tb.o : test_myip_v1_0_HLS.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_myip_v1_0_HLS.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/myip_v1_0_HLS.cpp_pre.cpp.tb.o : myip_v1_0_HLS.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling myip_v1_0_HLS.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
