...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.myip_v1_0_HLS.autotvin_S_AXIS_V_data.dat"
         "c.myip_v1_0_HLS.autotvin_S_AXIS_V_last.dat"
         "c.myip_v1_0_HLS.autotvin_M_AXIS_V_data.dat"
         "c.myip_v1_0_HLS.autotvin_M_AXIS_V_last.dat"
         "c.myip_v1_0_HLS.autotvout_M_AXIS_V_data.dat"
         "c.myip_v1_0_HLS.autotvout_M_AXIS_V_last.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.myip_v1_0_HLS.autotvout_M_AXIS_V_data.dat"
         "rtl.myip_v1_0_HLS.autotvout_M_AXIS_V_last.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
