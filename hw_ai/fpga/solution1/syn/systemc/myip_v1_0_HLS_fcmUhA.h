...
// ==============================================================
#ifndef __myip_v1_0_HLS_fcmUhA__HH__
#define __myip_v1_0_HLS_fcmUhA__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myip_v1_0_HLS_fcmUhA) {
    ...
    SC_CTOR(myip_v1_0_HLS_fcmUhA):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
