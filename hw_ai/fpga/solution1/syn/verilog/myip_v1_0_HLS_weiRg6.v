...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module myip_v1_0_HLS_weiRg6_rom (
addr0, ce0, q0, addr1, ce1, q1, addr2, ce2, q2, addr3, ce3, q3, addr4, ce4, q4, addr5, ce5, q5, addr6, ce6, q6, addr7, ce7, q7, addr8, ce8, q8, addr9, ce9, q9, addr10, ce10, q10, clk);

parameter DWIDTH = 32;
parameter AWIDTH = 10;
parameter MEM_SIZE = 860;
...
initial begin
    $readmemh("./myip_v1_0_HLS_weiRg6_rom.dat", ram0);
    $readmemh("./myip_v1_0_HLS_weiRg6_rom.dat", ram1);
    $readmemh("./myip_v1_0_HLS_weiRg6_rom.dat", ram2);
    $readmemh("./myip_v1_0_HLS_weiRg6_rom.dat", ram3);
    $readmemh("./myip_v1_0_HLS_weiRg6_rom.dat", ram4);
    $readmemh("./myip_v1_0_HLS_weiRg6_rom.dat", ram5);
end
...
parameter AddressRange = 32'd860;
...
myip_v1_0_HLS_weiRg6_rom myip_v1_0_HLS_weiRg6_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
