...
HLS_SOURCES = ../../../test_myip_v1_0_HLS.cpp ../../../myip_v1_0_HLS.cpp
...
$(ObjDir)/myip_v1_0_HLS.o: ../../../myip_v1_0_HLS.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../myip_v1_0_HLS.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/myip_v1_0_HLS.d
