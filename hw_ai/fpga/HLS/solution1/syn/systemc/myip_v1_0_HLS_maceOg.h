...
// ==============================================================
#ifndef __myip_v1_0_HLS_maceOg__HH__
#define __myip_v1_0_HLS_maceOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(myip_v1_0_HLS_maceOg) {
    ...
    SC_CTOR(myip_v1_0_HLS_maceOg):  simcore_mac_0_U ("simcore_mac_0_U") {
