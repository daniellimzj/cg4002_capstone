...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(myip_v1_0_HLS_bias1_ram) {
        ram[0] = "0b10111111110100110011100111101000";
        ram[1] = "0b00111101111001111111000010010000";
        ram[2] = "0b00111111110011011001001101110101";
        ram[3] = "0b00111111100101000101000110101111";
        ram[4] = "0b11000000001110111010000101001011";
