...
// ==============================================================
#ifndef __myip_v1_0_HLS_fptocq__HH__
#define __myip_v1_0_HLS_fptocq__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(myip_v1_0_HLS_fptocq) {
    ...
    SC_CTOR(myip_v1_0_HLS_fptocq):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
