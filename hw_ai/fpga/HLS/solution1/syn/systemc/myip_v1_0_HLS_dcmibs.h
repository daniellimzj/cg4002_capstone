...
// ==============================================================
#ifndef __myip_v1_0_HLS_dcmibs__HH__
#define __myip_v1_0_HLS_dcmibs__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myip_v1_0_HLS_dcmibs) {
    ...
    SC_CTOR(myip_v1_0_HLS_dcmibs):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
