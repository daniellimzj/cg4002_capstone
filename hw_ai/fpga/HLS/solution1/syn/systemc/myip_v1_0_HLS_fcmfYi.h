...
// ==============================================================
#ifndef __myip_v1_0_HLS_fcmfYi__HH__
#define __myip_v1_0_HLS_fcmfYi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myip_v1_0_HLS_fcmfYi) {
    ...
    SC_CTOR(myip_v1_0_HLS_fcmfYi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
